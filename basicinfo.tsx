...
const yourName : String = "Cornelia Meiss";
let yourPronouns : String = "She/Her";
const yourMajor : String = "Computer Science & Cognitive Science";
let classification : String = "soph";
let oneExcite : String = "Programming websites";
let anyConcerns : String = "Catching up on Github knowledge";
let funFact : String = "I am on the rowing team";
*/